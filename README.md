...
!!! note Checklist
    - [x] Create an empty repository (namely, `https://github.com/okatsn/TWAISWCF.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
...
Connect to remote:
1. Switch to the local directory of this project (TWAISWCF)
2. Add an empty repo TWAISWCF(.jl) on github (without anything!)
